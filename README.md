...
Web based untuk memprediksi klasifikasi tingkat kesehatan makanan (*Healthy* vs *Unhealthy*) secara real-time menggunakan model Machine Learning **Random Forest Classifier** yang diekspor ke dalam runtime format **ONNX (Open Neural Network Exchange)** untuk komputasi sisi klien yang efisien.
